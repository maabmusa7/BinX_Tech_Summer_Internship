...
- [x] Evaluate the model with MAE, RMSE, and R² on the test set.
- [x] Compare the RMSE against a baseline that predicts the mean for every row, and state whether the
model adds value.
